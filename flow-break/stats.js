...
export function closeSitSession() {
...
export function closeBreakSession(endTime) {
...
export function onPresenceGained() {
...
export function cancelAlarmAwayTimer() {
  if (alarmAwayTimer) { clearTimeout(alarmAwayTimer); alarmAwayTimer = null; }
}
